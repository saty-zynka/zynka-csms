...
Bugs are reported and tracked via [GitHub issues](https://github.com/zynka-csms/issues). Please use this platform
...
1. Fork the repository by clicking the "Fork" button on the [repository's page](https://github.com/zynka-csms).
...
out [this commit](https://github.com/zynka-csms/commit/2c64552a689f185728566c841bfa7609469015f5) as a reference
